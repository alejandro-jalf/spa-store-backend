...
const modelsMayoristas = (() => {
    ...
    const sentence = 
        ...
        DECLARE @Almacen INT = CASE WHEN @Sucursal = 'ZARAGOZA' THEN 2 WHEN @Sucursal = 'VICTORIA' THEN 3 WHEN @Sucursal = 'OLUTA' THEN 19 WHEN @Sucursal = 'JALTIPAN' THEN 7 WHEN @Sucursal = 'BODEGA' THEN 21 ELSE 0 END;
        DECLARE @Tienda INT = CASE WHEN @Sucursal = 'ZARAGOZA' THEN 1 WHEN @Sucursal = 'VICTORIA' THEN 2 WHEN @Sucursal = 'OLUTA' THEN 5 WHEN @Sucursal = 'JALTIPAN' THEN 4 WHEN @Sucursal = 'BODEGA' THEN 6 ELSE 0 END;
